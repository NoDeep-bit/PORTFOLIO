    ...
    <Html lang="fr">
        ...
        <body>
          <header class="header">
            ...
            <div class="block">
              <div class="banner">
                <img src="asset/emile-perron-xrVDYZRGdw4-unsplash.jpg"  class="banner-image" alt="Ordinateur Portable sur Bureau">
